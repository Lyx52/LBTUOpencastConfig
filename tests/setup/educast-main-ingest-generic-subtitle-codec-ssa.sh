...
oc_mediapackage_add_track       "$MP"  captions/source+de      "$MEDIA_DIR/full-tears-of-steel-deu.ssa"
oc_mediapackage_add_track       "$MP"  captions/source+en      "$MEDIA_DIR/full-tears-of-steel-eng.ssa"
oc_mediapackage_add_track       "$MP"  captions/source+fr      "$MEDIA_DIR/full-tears-of-steel-fra.ssa"
oc_mediapackage_add_track       "$MP"  captions/source+es      "$MEDIA_DIR/full-tears-of-steel-spa.ssa"
