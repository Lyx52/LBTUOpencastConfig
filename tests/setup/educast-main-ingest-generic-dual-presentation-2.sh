...
oc_mediapackage_add_track       "$MP"  presenter-2/source        "$MEDIA_DIR/short-big-buck-bunny.mp4"
oc_mediapackage_add_track       "$MP"  presentation-1/source   "$MEDIA_DIR/short-big-buck-bunny.mp4"
oc_mediapackage_add_track       "$MP"  presentation-2/source   "$MEDIA_DIR/short-big-buck-bunny.mp4"
