...
oc_mediapackage_add_track       "$MP"  captions/source+de      "$MEDIA_DIR/full-tears-of-steel-deu.sub"
oc_mediapackage_add_track       "$MP"  captions/source+en      "$MEDIA_DIR/full-tears-of-steel-eng.sub"
oc_mediapackage_add_track       "$MP"  captions/source+fr      "$MEDIA_DIR/full-tears-of-steel-fra.sub"
oc_mediapackage_add_track       "$MP"  captions/source+es      "$MEDIA_DIR/full-tears-of-steel-spa.sub"
