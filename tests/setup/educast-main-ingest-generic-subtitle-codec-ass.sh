...
oc_mediapackage_add_track       "$MP"  captions/source+de      "$MEDIA_DIR/full-tears-of-steel-deu.ass"
oc_mediapackage_add_track       "$MP"  captions/source+en      "$MEDIA_DIR/full-tears-of-steel-eng.ass"
oc_mediapackage_add_track       "$MP"  captions/source+fr      "$MEDIA_DIR/full-tears-of-steel-fra.ass"
oc_mediapackage_add_track       "$MP"  captions/source+es      "$MEDIA_DIR/full-tears-of-steel-spa.ass"
