...
oc_mediapackage_add_track       "$MP"  captions/source+de      "$MEDIA_DIR/full-tears-of-steel-deu.vtt"
oc_mediapackage_add_track       "$MP"  captions/source+en      "$MEDIA_DIR/full-tears-of-steel-eng.vtt"
oc_mediapackage_add_track       "$MP"  captions/source+fr      "$MEDIA_DIR/full-tears-of-steel-fra.vtt"
oc_mediapackage_add_track       "$MP"  captions/source+es      "$MEDIA_DIR/full-tears-of-steel-spa.vtt"
